...
TARGET := gateway:/opt/public-dev/tcsv2png
...
distrib:
	-scp dist/tcsv2png-*.tar.gz $(TARGET)/snapshots
	-scp dist/tcsv2png-*.egg $(TARGET)/snapshots
...
clean:
	...
	rm -rf ./build ./dist ./MANIFEST ./tcsv2png.egg-info
